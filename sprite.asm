...
elseif getfilestatus("!sprite") == 0 && readfile4("!sprite", 0) != $5250535A
	...
	while !metadata_index < !gfx_offset && !junk > 0
		!value #= readfile2("!sprite", !metadata_index, 0)
		if !value == 0
			!junk #= !junk-1
		endif
	...
	!length = 0
	while !metadata_index < !gfx_offset && readfile1("!sprite", !metadata_index, 0) != 0 && !length < 28
		!length #= !length+1
	...
	!i = 0
	while !i < !length
		!value #= readfile1("!sprite", !author_start+!i)
